...
export const TOOLS = [
  ...
  { id: 'database', name: 'Database',      state: 'live',      note: 'Supabase Postgres: the Archives modules, content drafts and revisions, agent runs, system events. Reached only through /api and the tools, with the service key; the browser never touches it directly.' },
...
export const AGENTS = [
  ...
  },
  {
    ...
    tools: ['memory', 'notion', 'archives', 'database'],
