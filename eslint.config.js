...
export default [
  ...
  {
    files: ['packages/ai/src/**/*.js', 'packages/agents/src/**/*.js', 'tools/verify-models.mjs', 'tools/ai.test.mjs', 'tools/ai-data.test.mjs', 'packages/database/src/ai.js', 'tools/agents-runner.test.mjs', 'api/ai.js', 'api/tick.js'],
