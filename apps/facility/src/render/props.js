...
export const WALL_MOUNTED = new Set(['screen', 'bigscreen', 'board', 'window', 'cardwall', 'productshelf', 'corkboard', 'switchwall', 'maprack', 'shelf', 'vent', 'pipe', 'rug', 'coldstore', 'vialrack', 'servers', 'safe', 'lift', 'mast', 'radio', 'ladder', 'cabinet', 'locker', 'lever']);
